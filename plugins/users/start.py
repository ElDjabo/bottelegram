    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                ...
                InlineKeyboardButton("💵 Recarregar", callback_data="add_saldo"),
            ],  
...
InlineKeyboardButton("🕹 Cassino",  callback_data='cassino'),
            ...
            [
   InlineKeyboardButton("♻️ Trocar GG", url="https://t.me/huntercenter7"),   
    ...
    start_message = f"""‌<a href='{bot_logo}'>&#8204</a><b><b> 🛒 | Loja de Ggs - {BOT_LINK}
"""
