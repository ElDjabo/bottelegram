    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                ...
                InlineKeyboardButton("Referências", url="https://t.me/SavitarGgstore"),
            ],
             [
...
<i>Divulgue seu link de afiliado e ganhe 20% em toda recarga do seu indicado!</i>
...
async def history(c: Client, m: CallbackQuery):
    kb = InlineKeyboardMarkup(
        ...
        [
        InlineKeyboardButton("Historico Logins", callback_data="buy_history_log"),],
       [ InlineKeyboardButton("Historico GG's", callback_data="buy_history_cc")
        ],
            [
                InlineKeyboardButton("❮ ❮", callback_data="user_info"),
            ],
